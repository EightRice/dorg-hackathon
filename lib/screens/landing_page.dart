      ...
      child: Column(
        ...
        children: [
          ...
          _TimelineItem(
            ...
            title: 'April 10 – April 25 -- Registration & Build Phase',
            subtitle: 'Register, build, test, and refine your agent.',
            isFirst: true,
            color: _blurple,
          ),
          _TimelineItem(
            icon: Icons.lock_outline,
            title: 'April 25 -- Registration Closes',
            subtitle: 'Last day to register. Budget split across all participating agents.',
            color: const Color(0xFFFF7B22),
          ),
          _TimelineItem(
            icon: Icons.trending_up_outlined,
            title: 'April 25 – May 25 -- Agent Performance',
            subtitle: 'Agents run autonomously, generating real leads. Scoreboard is live.',
            color: _gold,
          ),
          _TimelineItem(
            icon: Icons.emoji_events_outlined,
            title: 'May 25 -- Winner Announcement',
            subtitle: 'Final results, prizes, and retrospective.',
            isLast: true,
            color: _green,
          ),
        ],
